...
git config --global user.name "YOUR_NAME@lianjia.com"
```

* git clone git@git.lianjia.com:fangtao/GitTraining.git
...
* 在浏览器中打开 [链接](http://git.lianjia.com/fangtao/GitTraining/commits/master) 查看是否提交成功
