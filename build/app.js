...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  getIndex: function getIndex() {
	    ...
	    _data2.default.nav.forEach(function () {
	  ...
	  renderList: function renderList(categories) {
	    ...
	    var dataList = categories === 'index' ? _data2.default.article : _data2.default.article.filter(function () {
	    ...
	    var list = dataList.map(function () {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '' + _this2.props.hashRoot + arg[0].categories + '/' + arg[0].name },
	          arg[0].title
	        )
	      );
	    });
	  ...
	  renderArticle: function renderArticle(categories, article, listName) {
	    ...
	    if (['nav', 'about'].indexOf(categories) === -1 && article !== 'index' && !_data2.default.article.filter(function () {
	    ...
	    var url = '' + this.props.docRoot + [categories, article].join('/') + '.md';
	    this.setState({
	      isLoading: true
	    });
	    if (window.fetch) {
	      fetch(url).then(function (rs) {
	        if (rs.ok) {
	          rs.text().then(function (rs) {
	            _this3.setState({
	              content: listName ? '<div class="p-' + listName + '">' + (0, _marked2.default)(rs) + '</div>' : '<div class="markdown"><a target="_blank" href="http://shuoshubao.com/docs/' + [categories, article].join('/') + '.md")>源码</a>' + (0, _marked2.default)(rs) + '</div>'
	            });
	            _this3.hideLoading();
	          });
	        } else {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'home', href: this.props.hashRoot + 'index' },
	              _react2.default.createElement('img', { className: 'logo', width: '36', height: '36', src: 'http://facebook.github.io/react/img/logo.svg' }),
	              _react2.default.createElement(
	                'span',
	                { className: 'name' },
	                '硕鼠宝'
	            ...
	            _react2.default.createElement(
	              'span',
	              { className: 'btn-navbar ' + (this.state.openNav ? 'active' : ''), onClick: this.openNav },
	              new Array(4).fill(1).map(function () {
	                return _react2.default.createElement('span', { key: arguments.length <= 1 ? undefined : arguments[1], className: 'icon-bar' });
	              })
	            ),
	            _react2.default.createElement(
	              'ul',
	              { style: { height: this.state.openNav ? _data2.default.nav.length * 40 + 20 : 0 } },
	              _data2.default.nav.map(function () {
	                ...
	                return _react2.default.createElement(
	                  'li',
	                  { key: arg[1], className: _this4.state.navIndex === arg[1] ? 'active' : '' },
	                  _react2.default.createElement(
	                    'a',
	                    { href: '' + _this4.props.hashRoot + _data2.default.nav[arg[1]].categories },
	                    arg[0].text
	                  )
	                );
	              })
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'btn-github', target: '_blank', href: _data2.default.meta.githubLink },
	              'GitHub'
	            )
	          )
	        )
	      ...
	      function () {
	        if (typeof _this4.state.content === 'string') {
	          return _react2.default.createElement('article', { className: 'g-content', ref: 'content', dangerouslySetInnerHTML: { __html: _this4.state.content } });
	        } else {
	          return _react2.default.createElement(
	            'article',
	      ...
	      _react2.default.createElement(
	        'section',
	        { className: 'g-loading ' + (this.state.isLoading ? '' : 'hide') },
	        _react2.default.createElement(
	          'div',
	          { className: 'w-loading ' },
	          _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { target: '_blank', href: _data2.default.meta.githubLink },
	              ' GitHub '
	            ),
	            _react2.default.createElement(
	              'a',
