                ...
                <Layout hasSider>
                    ...
                    >
                        <Sider theme="light" width="100%" collapsible collapsedWidth={0} collapsed={collapsed} trigger={null}>
                            <div className={styles['sider-container']} style={{ height: 'calc(100vh - 64px)', padding: token.paddingContentVertical }}>
                                <Tabs
                                    type="card"
                    ...
                    <Content ref={iframeRef} className={styles['iframe-container']} style={{ padding: token.paddingContentVertical }} />
                </Layout>
            </Layout>
            <Modal
                title="设置"
