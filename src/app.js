  ...
  render() {
    ...
    return (
      <div>
        <nav className={styles['g-nav']}>
          <div className={styles.inner}>
            <div className={styles.wrap}>
              ...
              <span className={classnames(styles['btn-navbar'], openNav ? styles.active : '')} onClick={this.openNav.bind(this)} dangerouslySetInnerHTML={{__html: `<span class="${styles['icon-bar']}"></span>`.repeat(4)}} />
        ...
        <section className={classnames(styles['g-loading'], isLoading ? '' : styles.hide)}>
